...
async function seedExercises() {
  try {
    ...
    if (existingExercises.length > 0) {
      console.log(`Found ${existingExercises.length} existing exercises. Updating to published...`);
      
      // Update existing exercises to published
      await prisma.exercise.updateMany({
        where: {},
        data: { published: true }
      });
      
      console.log('✅ Existing exercises updated to published!');
      return;
    }
    ...
    const exercises = [
      {
        title: 'Two Sum',
        description: 'Verilmiş array və target üçün iki indeksin cəmi target-ə bərabər olan index-lərini qaytaran funksiya yazın.',
        difficulty: 'EASY',
        category: 'ALGORITHMS',
        published: true,
        content: {
    ...
    for (let i = 0; i < nums.length; i++) {
      ...
      map[nums[i]] = i;
          ...
          timeComplexity: "O(n)",
          spaceComplexity: "O(n)",
          hints: ["Hash map istifadə edin", "Hər element üçün target - element hesablayın"],
          testCases: [
      ...
      },
      {
        ...
        description: 'Verilmiş iki sıralanmış array-in medianını qaytaran funksiya yazın.',
        difficulty: 'HARD',
        category: 'ALGORITHMS',
        published: true,
        content: {
    ...
    if (merged.length % 2 === 0) {
      ...
      return merged[mid];
          ...
          hints: ["Array-ləri birləşdirin və sıralayın", "Median hesablamaq üçün ortadakı elementləri tapın"],
          testCases: [
      ...
      },
      {
        ...
        description: 'Verilmiş array-də maksimum su tutumu olan iki index arasındakı məsafəni hesablayın.',
        difficulty: 'MEDIUM',
        category: 'ALGORITHMS',
        published: true,
        content: {
    ...
    return maxArea;
          ...
          timeComplexity: "O(n)",
          spaceComplexity: "O(1)",
          hints: ["İki pointer istifadə edin", "Hündürlük və eni vuraraq sahəni hesablayın"],
          testCases: [
    ...
    return false;
          ...
          spaceComplexity: "O(1)",
          hints: ["Matrix-i 1D array kimi təsəvvür edin", "Binary search istifadə edin"],
          testCases: [
      ...
      },
      {
        ...
        description: 'Verilmiş string-də mötərizələrin düzgün olub olmadığını yoxlayın.',
        difficulty: 'EASY',
        category: 'ALGORITHMS',
        published: true,
        content: {
    ...
    return stack.length === 0;
          ...
          timeComplexity: "O(n)",
          spaceComplexity: "O(n)",
          hints: ["Stack istifadə edin", "Açılan mötərizələri stack-ə əlavə edin"],
          testCases: [
    ...
    return chars.join('');
      ...
      },
      {
        ...
        description: 'Verilmiş array-də maksimum cəmi olan ardıcıl alt array-i tapın.',
        difficulty: 'MEDIUM',
        category: 'ALGORITHMS',
        published: true,
        content: {
    ...
    return maxSoFar;
          ...
          timeComplexity: "O(n)",
          spaceComplexity: "O(1)",
          hints: ["Kadane's algorithm istifadə edin", "Hər addımda maksimum cəmi yeniləyin"],
          testCases: [
    ...
    return result;
          ...
          timeComplexity: "O(n)",
          spaceComplexity: "O(n)",
          hints: ["Recursion istifadə edin", "Sol alt ağac, kök, sağ alt ağac sırası"],
          testCases: [
    ...
    empty() {
      return this.queue1.length === 0;
          ...
          spaceComplexity: "O(n)",
          hints: ["İki queue istifadə edin", "Push zamanı elementləri yenidən düzəldin"],
          testCases: [
            { input: '["MyStack","push","push","top","pop","empty"]\n[[],[1],[2],[],[],[]]', expectedOutput: '[null,null,null,2,2,false]' }
          ]
        }
      },
      {
